...
x_threads = numpy.array([0, 1, 10, 50, 100, 200, 300, 400])

y_samples = numpy.array([0, 6164, 32355, 31759, 34691, 39363, 36888, 37652])
y_average = numpy.array([0, 48, 92, 472, 866, 1526, 2447, 3199])
y_tps = numpy.array([0, 20.5, 107.8, 105.8, 115.4, 130.8, 122.2, 124.5])
